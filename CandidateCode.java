...
public static int wordChain(String input1)
{
    ...
    boolean ischain = hasChain(stringList);
    if (ischain) {
     return chainLength;    
    }
    return 0;
...
static Map<Character, List<String>> startsWith = new HashMap<Character, List<String>>();
static Map<Character, List<String>> endsWith = new HashMap<Character, List<String>>();
...
public static boolean hasChain(List<String> stringList) {
...
public static boolean hasChain(int size, String startString, Stack<String> stringStack) {
